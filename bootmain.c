...
//Abhijit: read ph->filesz bytes into 'pa' from ph->off in kernel/disk
  ...
  // Does not return!
//Abhijit: elf-> entry was set by linker using kernel.id 
//this is address 0x80100000 specified in kernel.id
